...
func main() {
    ...
    res, err := s.Events.IngestEvent(ctx, types.IngestEventRequest{
        CustomerID: omkarsdk.Pointer("customer456"),
        EventID: omkarsdk.Pointer("event123"),
        ...
        Source: omkarsdk.Pointer("api"),
        Timestamp: omkarsdk.Pointer("2024-03-20T15:04:05Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
import(
	"context"
	omkarsdk "github.com/omkar273/wl-go-sdk/v2"
	"github.com/omkar273/wl-go-sdk/v2/types"
	"github.com/omkar273/wl-go-sdk/v2/models/types"
	"log"
)
...
func main() {
    ...
    res, err := s.Events.ListRawEvents(ctx, types.GetEventsRequest{
        ...
        Order: omkarsdk.Pointer("desc"),
        Sort: omkarsdk.Pointer("timestamp"),
...
func main() {
    ...
    res, err := s.Events.GetUsageStatistics(ctx, types.GetUsageRequest{
        ...
        EventName: "api_request",
        ExternalCustomerID: omkarsdk.Pointer("customer456"),
        PropertyName: omkarsdk.Pointer("request_size"),
...
func main() {
    ...
    res, err := s.Events.GetUsageByMeter(ctx, types.GetUsageByMeterRequest{
        ...
        CustomerID: omkarsdk.Pointer("customer456"),
        EndTime: types.MustNewTimeFromString("2024-12-09T00:00:00Z"),
        ExternalCustomerID: omkarsdk.Pointer("user_5"),
        MeterID: "123",
        StartTime: types.MustNewTimeFromString("2024-11-09T00:00:00Z"),
    })
    if err != nil {
