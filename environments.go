...
func newEnvironments(rootSDK *Omkar, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Environments {
	return &Environments{
		rootSDK:          rootSDK,
...
func (s *Environments) CloneEnvironment(ctx context.Context, id string, body types.CloneEnvironmentRequest, opts ...dtos.Option) (*dtos.CloneEnvironmentResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/environments/{id}/clone", request, nil)
	if err != nil {
	...
	res := &dtos.CloneEnvironmentResponse{
