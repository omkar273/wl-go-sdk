...
func newWorkflows(rootSDK *Omkar, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Workflows {
	return &Workflows{
		rootSDK:          rootSDK,
...
func (s *Workflows) QueryWorkflow(ctx context.Context, request types.WorkflowExecutionFilter, opts ...dtos.Option) (*dtos.QueryWorkflowResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/workflows/search")
	if err != nil {
	...
	res := &dtos.QueryWorkflowResponse{
