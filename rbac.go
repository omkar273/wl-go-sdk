...
func newRbac(rootSDK *Omkar, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Rbac {
	return &Rbac{
		rootSDK:          rootSDK,
...
func (s *Rbac) ListRbacRoles(ctx context.Context, opts ...dtos.Option) (*dtos.ListRbacRolesResponse, error) {
	o := dtos.Options{}
	...
	opURL, err := url.JoinPath(baseURL, "/rbac/roles")
	if err != nil {
	...
	res := &dtos.ListRbacRolesResponse{
...
func (s *Rbac) GetRbacRole(ctx context.Context, id string, opts ...dtos.Option) (*dtos.GetRbacRoleResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/rbac/roles/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
