...
func newAlerts(rootSDK *Omkar, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Alerts {
	return &Alerts{
		rootSDK:          rootSDK,
...
func (s *Alerts) QueryAlertLog(ctx context.Context, request types.AlertLogFilter, opts ...dtos.Option) (*dtos.QueryAlertLogResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/alerts/search")
	if err != nil {
	...
	res := &dtos.QueryAlertLogResponse{
