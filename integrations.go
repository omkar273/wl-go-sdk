...
import (
	...
	"context"
	"fmt"
	"github.com/omkar273/wl-go-sdk/v2/internal/config"
	"github.com/omkar273/wl-go-sdk/v2/internal/hooks"
	"github.com/omkar273/wl-go-sdk/v2/internal/utils"
	"github.com/omkar273/wl-go-sdk/v2/models/dtos"
	"github.com/omkar273/wl-go-sdk/v2/models/errors"
	"github.com/omkar273/wl-go-sdk/v2/models/types"
	"github.com/omkar273/wl-go-sdk/v2/retry"
	"net/http"
	"net/url"
)
...
func newIntegrations(rootSDK *Omkar, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Integrations {
	return &Integrations{
		rootSDK:          rootSDK,
...
func (s *Integrations) GetIntegrationConfig(ctx context.Context, opts ...dtos.Option) (*dtos.GetIntegrationConfigResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/integrations/config")
	if err != nil {
	...
	res := &dtos.GetIntegrationConfigResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.IntegrationConfigResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.IntegrationConfigResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Integrations) LinkIntegrationMapping(ctx context.Context, request types.LinkIntegrationMappingRequest, opts ...dtos.Option) (*dtos.LinkIntegrationMappingResponse, error) {
	...
	res := &dtos.LinkIntegrationMappingResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *Integrations) GetEntityIntegrationMappings(ctx context.Context, entityType string, entityID string, opts ...dtos.Option) (*dtos.GetEntityIntegrationMappingsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/integrations/mappings")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &dtos.GetEntityIntegrationMappingsResponse{
		HTTPMeta: types.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out types.ListEntityIntegrationMappingsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ListEntityIntegrationMappingsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
