...
// Generated from OpenAPI doc version 1.0 and generator version 2.892.5
...
// Omkar - Flexprice API: Flexprice API Service
type Omkar struct {
	SDKVersion      string
	Addons          *Addons
...
type SDKOption func(*Omkar)

// WithServerURL allows providing an alternative server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *Omkar) {
...
func New(opts ...SDKOption) *Omkar {
	sdk := &Omkar{
		SDKVersion: "2.0.0-wltest",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 2.0.0-wltest 2.892.5 1.0 github.com/omkar273/wl-go-sdk/v2",
